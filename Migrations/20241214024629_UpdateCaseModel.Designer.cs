...
namespace CaseRelayAPI.Migrations
{
    ...
    [Migration("20241214024629_UpdateCaseModel")]
    partial class UpdateCaseModel
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CaseRelayAPI.Models.Case", b =>
                {
                    ...
                    b.Property<int>("OfficerAssignedUserID")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("OfficerAssignedUserID");
            ...
            modelBuilder.Entity("CaseRelayAPI.Models.Case", b =>
                {
                    b.HasOne("CaseRelayAPI.Models.User", "OfficerAssigned")
                        .WithMany()
                        .HasForeignKey("OfficerAssignedUserID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("OfficerAssigned");
                });
